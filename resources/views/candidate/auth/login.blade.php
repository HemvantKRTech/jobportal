                                            ...
                                            <form method="POST" action="{{ route('admin.login.post') }}" id="loginform">
                                                ...
                                                <div class="mb-3 {{ $errors->has('password') ? ' has-error' : '' }}">
                                                    ...
                                                    <div class="mb-3 position-relative auth-pass-inputgroup">
                                                        <input type="password" name="password" id="password-input" class="form-control password-input" placeholder="Password">
                                                ...
                                                <div class="mt-4">
                                                    <button type="submit" class="loginBtn btn btn-success w-100">Sign In</button>
                                                </div>
                                            </form>
                                            <div class="mt-4 text-center">
                                                <div class="signin-other-title">
                                                    <h5 class="fs-13 mb-4 title text-muted">Login With</h5>
                                                </div>
                                                <div>
